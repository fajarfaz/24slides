...
<div class="container-fluid">
  <h4 class="bd-title">Absent Report</h4>
	...
	<tbody>
		...
		@if($karyawan != null)
			...
			<tr>
				...
				<td>
					@if($jadwal->absen == null)
						-
					@elseif($jadwal->absen->kode == 'E')
                      Early
                    @elseif($jadwal->absen->kode == 'V')
                      Ontime
                    @elseif($jadwal->absen->kode == 'L')
                      Late
                    @elseif($jadwal->absen->kode == 'A')
                      Absent
                    @elseif($jadwal->absen->kode == 'Vr')
                      Remote work
                    @elseif($jadwal->absen->kode == 'I')
                      Ijin
                    @endif
				</td>
			</tr>
